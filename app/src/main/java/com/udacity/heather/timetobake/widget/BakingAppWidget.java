...
public class BakingAppWidget extends AppWidgetProvider {
    ...
    static void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
        ...
        views = getSingleIngredientRemoteView(context, recipes, newRecipePosition, appWidgetId, appWidgetManager);
     ...
     */
    private static RemoteViews getSingleIngredientRemoteView(Context context, List<Recipe> recipes, int newRecipePosition,
        ...
        if (currentRecipe != null) {
            ...
            previousRecipeIntent.putExtra(Constants.CURRENT_RECIPE_POSITION_KEY_WIDGET, mCurrentRecipePosition);
            ...
            nextRecipeIntent.putExtra(Constants.CURRENT_RECIPE_POSITION_KEY_WIDGET, mCurrentRecipePosition);
